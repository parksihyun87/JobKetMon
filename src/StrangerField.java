...
public class StrangerField implements Field{
    ...
    public void callStrangerField(ArrayList<PMAction> mJobKiMonBox){
        ...
        if(mBattle.fight(elecList,mJobKiMonBox)){
            ...
            System.out.println("길을 만들어가려는 자의 종국에 닥칠일도 일반이나, 최후에 누여질 장소의 의미가 다르리라.");
            System.out.println("비록 시간속에서 많은 것들이 퇴색하겠으나 사람들안에서만 전해지는 '의미'라는 것들은 인생의 바다안에 영원히 존재할 것이다.'");
